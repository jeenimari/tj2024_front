...
//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList)//주간 박스오피스의 
//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].rank); //주간 박스오피스의 2번째 영화정보 순위
//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].movieNm);//주간 박스오피스의 2번째 영화정보의 영화명
...
for(let index = 0 ; index <=영화정보.boxOfficeResult.weeklyBoxOfficeList.length-1; index++){
    //인덱스는 0부터 주간 박스오피스의 마지막인덱스까지 1씩 증가 반복
